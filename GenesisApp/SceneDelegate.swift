...
//            window.rootViewController = UIHostingController(rootView: contentView.environmentObject(SessionStore()))
            window.rootViewController = UIHostingController(rootView: MotherView().environmentObject(ViewRouter()).environmentObject(SessionStore()))
            self.window = window
        ...
        tapGesture.delegate = self //not use window as delegate to minimize possible side effects
